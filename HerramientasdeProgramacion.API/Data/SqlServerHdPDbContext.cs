    ...
    public class SqlServerHdPDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cancion>()
                .HasOne(c => c.Artista)
                .WithMany(a => a.Canciones) // si Artista tiene ICollection<Cancion>
                .HasForeignKey(c => c.ArtistaId)
                .OnDelete(DeleteBehavior.Restrict); // evitar eliminación en cascada accidental

            // Cancion → Usuario
            modelBuilder.Entity<Cancion>()
                .HasOne(c => c.Usuario)
                .WithMany(u => u.CancionesSubidas)
