...
namespace HerramientasdeProgramacion.MVC.Controllers
{
    ...
    public class AlbumesController : Controller
    {
        ...
        public async Task<IActionResult> Create(string titulo, DateTime fechaLanzamiento)
        {
            var userEmail = User.Identity?.Name;
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ArtistaId"] = new SelectList(_context.Usuarios, "Id", "Email", album.ArtistaId);
            return View(album);
        }
